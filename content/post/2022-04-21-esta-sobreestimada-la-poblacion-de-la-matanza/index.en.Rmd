...
ife %>% 
  ...
  geom_text(data= ife %>% filter(denominacion == "La Matanza"),
            aes(label = denominacion, y=cantidad_ife/personas*100), x=12.1, size=5, inherit.aes = FALSE) +
  theme_classic() +
  labs(x="Tasa de pobreza crónica", y="Asignaciones de IFE cada 100 habitantes estimados, 2020", 
